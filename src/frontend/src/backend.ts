...
import type { Certification as _Certification, Education as _Education, Language as _Language, PersonalInfo as _PersonalInfo, Project as _Project, ResumeData as _ResumeData, SkillCategory as _SkillCategory, StripeSessionStatus as _StripeSessionStatus, UserRole as _UserRole, WorkExperience as _WorkExperience } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async deleteResume(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteResume();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async isPaid(arg0: Principal): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isPaid(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveResume(arg0: ResumeData): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveResume(to_candid_ResumeData_n15(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_ResumeData_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ResumeData): ResumeData {
...
function from_candid_WorkExperience_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _WorkExperience): WorkExperience {
...
function from_candid_opt_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ResumeData]): ResumeData | null {
    return value.length === 0 ? null : from_candid_ResumeData_n6(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        targetJobDescription: value.targetJobDescription,
        education: value.education,
        workExperience: from_candid_vec_n8(_uploadFile, _downloadFile, value.workExperience),
...
function from_candid_vec_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_WorkExperience>): Array<WorkExperience> {
    return value.map((x)=>from_candid_WorkExperience_n9(_uploadFile, _downloadFile, x));
}
function to_candid_ResumeData_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ResumeData): _ResumeData {
    return to_candid_record_n16(_uploadFile, _downloadFile, value);
}
function to_candid_UserRole_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: UserRole): _UserRole {
    return to_candid_variant_n2(_uploadFile, _downloadFile, value);
}
function to_candid_WorkExperience_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: WorkExperience): _WorkExperience {
...
function to_candid_record_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        targetJobDescription: value.targetJobDescription,
        education: value.education,
        workExperience: to_candid_vec_n17(_uploadFile, _downloadFile, value.workExperience),
        languages: value.languages,
        summary: value.summary,
        certifications: value.certifications,
        personalInfo: value.personalInfo,
...
function to_candid_vec_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<WorkExperience>): Array<_WorkExperience> {
    return value.map((x)=>to_candid_WorkExperience_n18(_uploadFile, _downloadFile, x));
}
